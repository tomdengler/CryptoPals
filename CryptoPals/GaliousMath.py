# see https://www.samiam.org/galois.html for source of details below
...
def gmix_column(a):
    r=[]
    r.append( gmultiply(a[0],2) ^ gmultiply(a[3],1) ^ gmultiply(a[2],1) ^ gmultiply(a[1],3))
    r.append( gmultiply(a[1],2) ^ gmultiply(a[0],1) ^ gmultiply(a[3],1) ^ gmultiply(a[2],3))
    r.append( gmultiply(a[2],2) ^ gmultiply(a[1],1) ^ gmultiply(a[0],1) ^ gmultiply(a[3],3))
